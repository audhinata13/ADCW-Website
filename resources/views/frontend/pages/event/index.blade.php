<x-frontend.main-layout title="{{ $title ?? '' }}">
    ...
    <div class="mt-10">
        @foreach ($items as $item)
            <div class="flex flex-row mb-10 gap-5">
                <div class="w-[30%]">
                    <img src="{{ $item->image() }}" alt=""
                        class=" border-15 rounded-xl object-cover h-60 w-[90%]">
                </div>
                <div class="w-[70%] flex items-center">
                    <div class="flex flex-col">
                        ...
                        <a href="{{ route('frontend.event.show', $item->slug) }}"
                            class="bg-[#001A3D] px-4 py-2 text-center rounded-lg text-white w-2/3">More
                            Info</a>
                    </div>
                </div>
            </div>
