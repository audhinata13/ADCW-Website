                    ...
                    <form action="{{ route('events.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <textarea name='fee_description' id='fee_description' cols='30' rows='3'
                                class='form-control @error('fee_description') is-invalid @enderror'>{{ old('fee_description') }}</textarea>
                        ...
                        <div class='form-group'>
                            ...
                            <select name='status' id='status'
                                ...
                                <option @selected(old('status') == 0) value="0">Closed</option>
                                <option @selected(old('status') == 1) value="1">Opened</option>
                                <option @selected(old('status') == 2) value="2">Finished</option>
                            </select>
                            @error('status')
                                <div class='invalid-feedback'>
                                    {{ $message }}
