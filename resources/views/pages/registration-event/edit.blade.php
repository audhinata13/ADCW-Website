<x-main-layout :title="$title">
    <x-section>
        <x-section-header :title="'Edit Previous Event'" :breadcrumbs="[
        ...
        <x-section-body>
            <x-section-card>
                <x-slot name="header">
                    <h4>Edit Previous Event</h4>
                </x-slot>
                <x-slot name="body">
                    <form action="{{ route('previous-events.update', $item->id) }}" method="post"
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='link_youtube' id='link_youtube'
                                ...
                                value='{{ $item->link_youtube ?? old('link_youtube') }}'>
                            @error('link_youtube')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
